...
<div class="container-fluid">
      ...
      <div class="jumbotron">
        <div class="row">
          <div class="col-lg-4 col-md-12 mb-4"> 
            <img src="assets/images/homepage-grid/g1.jpg" class="img-fluid mb-4" alt="">
            <img src="assets/images/homepage-grid/g2.jpg" class="img-fluid mb-4" alt="">
          </div>

          <div class="col-lg-4 col-md-12 mb-4">
            <img src="assets/images/homepage-grid/g3.jpg" class="img-fluid mb-4" alt="">
            <img src="assets/images/homepage-grid/g4.jpg" class="img-fluid mb-4" alt="">
          </div>

          <div class="col-lg-4 col-md-12 mb-4">
            <img src="assets/images/homepage-grid/g5.jpg" class="img-fluid mb-4" alt="">
            <img src="assets/images/homepage-grid/g6.jpg" class="img-fluid mb-4" alt="">
          </div>
        </div>
      </div>
  ...
  <div class="jumbotron mt-4">
    ...
    <h1 class="mb-5">Olá <?= ucfirst($user['nome']) ?>, seja bem-vindo à OLFake.</h1>
    <?php endif; ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <h4>Pesquisa Avançada</h4>
        ...
        <button form="form-filtros" class="btn btn-info mb-5">Filtrar</button>
    </div>
          ...
          <tr>
            <td>
              ...
              <a href="produto.php?id=<?= $anuncio['id'] ?>">
                <img height="80" class="rounded zoomin" src="assets/images/anuncios/default.jpg" alt="foto-anuncio">
              </a>
              <?php else: ?>
              <a href="produto.php?id=<?= $anuncio['id'] ?>">
                <img height="100" class="rounded zoomin" src="assets/images/anuncios/<?= $anuncio['url'] ?>" alt="foto-anuncio">
              </a>
              <?php endif; ?>
            </td>
            <td>
...
<footer class="text-center">
  <a class="signature" target="_blank" rel="noopener" href="https://github.com/LeoDev0/OLFake">Designed and Built with <span style="color:red;">❤️</span> By Leo Fernandes</a>
</footer>
