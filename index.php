...
<div class="container-fluid">
  ...
  <div class="bg-art rounded mt-4 mb-5 p-5 shadow-lg">
    <?php if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])): ?>
    <h1 class="mb-5 text-white text-shadow">Olá <?= ucfirst($user['nome']) ?>, seja bem-vindo à OLFake.</h1>
    <?php endif; ?>
    <h2 class="text-white text-shadow">Nossa loja já possui <?= $totalAnuncios['total'] ?> anúncios e <a href="vendedores.php" class="text-shadow"><?= $totalUsuarios['total'] ?> usuários cadastrados.</a></h2><br>
